...
namespace QLThuVien.Controllers
{
    public class NXBController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaNXB,TenNXB,Diachi,DienThoai")] NXB nXB)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaNXB,TenNXB,Diachi,DienThoai")] NXB nXB)
        {
            if (ModelState.IsValid)
            {
